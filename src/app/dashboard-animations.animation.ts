  ...
  transition('stationary => discard', [
    query('.uno-card-container', [
      ...
      group([
        ...
        animate('1s 0.5s ease-in-out', keyframes([
          style({ transform: "translateZ(0px) rotateY(180deg) rotateZ(180deg)", }),
          style({ transform: "translateZ(400px) rotateY(240deg) rotateZ(90deg)", }),
          style({ transform: "translateZ(0px) rotateY(360deg) rotateZ(0deg)", }),
        ]),),
      ]),
